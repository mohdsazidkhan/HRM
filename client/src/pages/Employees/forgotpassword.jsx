...
export const ForgotPassword = () => {
    ...
    useEffect(() => {
        if (EmplyoeeState.data) {
            loadingbar.current.complete()
            navigate("/employee/auth/reset-email-confirmation")
        }
    }, [EmplyoeeState.data])
    ...
    return (
        <div className="employee-login-container">
            ...
            <div className="employee-login-content flex justify-center items-center h-[100vh]">
                <ForgotPassowrd handleforgotpasswordsubmit={handleforgotpasswordsubmit} handlesforgotpasswordform={handlesforgotpasswordform} targetState={EmplyoeeState} redirectpath={"/employee/auth/login"}/>
            </div>
        </div>
    )
}