...
export const HRDesignationPageAsyncReducer = (builder, thunk) => {
    builder.addCase(thunk.pending, (state) => {
        state.isLoading = true;
        state.error.content = null;
    })
    builder.addCase(thunk.fulfilled, (state, action) => {
        if (action.payload.type === "AllDesignations") {
            state.isLoading = false;
            state.error.status = false;
            state.error.message = null
            state.error.content = null;
            ...
            action.payload.type === "CreateDesignation" ||
            action.payload.type === "DesignationDelete" ||
            action.payload.type === "DesignationEMUpdate" ||
            action.payload.type === "RemoveEmployeeDG" ||
            action.payload.type === "DesignationUpdate"
        ) {
            state.isLoading = false;
            state.error.status = false;
            state.error.message = null
        ...
        else if (action.payload.type === "GetDesignation") {
            state.isLoading = false;
            state.error.status = false;
            state.error.message = null
            state.error.content = null;
            ...
            // Fallback: treat as completed with provided data field if present
            state.isLoading = false;
