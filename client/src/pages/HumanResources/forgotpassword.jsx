...
export const HRForgotPasswordPage = () => {
    ...
    useEffect(() => {
        if (HRstate.data) {
            loadingbar.current.complete()
            navigate("/admin/auth/reset-email-confirmation")
        }
    }, [HRstate.data])
    ...
    return (
        ...
        <div className="employee-login-container">
            ...
            <div className="employee-login-content flex justify-center items-center h-[100vh]">
                <ForgotPassowrd handleforgotpasswordsubmit={handleforgotpasswordsubmit} handlesforgotpasswordform={handlesforgotpasswordform} targetState={HRstate} redirectpath={"/admin/auth/login"} />
            </div>
        </div>
