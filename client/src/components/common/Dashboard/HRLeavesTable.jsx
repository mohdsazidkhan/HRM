                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="cursor-pointer" onClick={() => toggleSort("startdate")}>Start Date</TableHead>
                            <TableHead className="cursor-pointer" onClick={() => toggleSort("enddate")}>End Date</TableHead>
                    ...
                    <TableBody>
                        {pageData.map((lv) => (
                            <TableRow key={lv._id}>
                                <TableCell className="font-medium">{lv.employee?.firstname} {lv.employee?.lastname || "-"}</TableCell>
                                <TableCell>{lv.title || "-"}</TableCell>
                                <TableCell className="max-w-[300px] truncate" title={lv.reason || "-"}>{lv.reason || "-"}</TableCell>
